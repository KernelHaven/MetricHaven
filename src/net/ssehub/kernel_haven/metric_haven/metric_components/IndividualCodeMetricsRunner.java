...
public class IndividualCodeMetricsRunner extends CodeMetricsRunner {
    ...
    //CHECKSTYLE:ON
            ...
            new MetricSelection(LoCMetric.class, LoCType.LOC, false),
            new MetricSelection(LoCMetric.class, LoCType.LOF, false),
            new MetricSelection(LoCMetric.class, LoCType.LOC_COMMENT_RATIO, false),
            new MetricSelection(LoCMetric.class, LoCType.LOF_COMMENT_RATIO, false),
            new MetricSelection(LoCMetric.class, LoCType.PLOF, false),
            new MetricSelection(LoCMetric.class, LoCType.SCOC, false),
            new MetricSelection(LoCMetric.class, LoCType.SCOF, false),
            new MetricSelection(LoCMetric.class, LoCType.SCOC_COMMENT_RATIO, false),
            new MetricSelection(LoCMetric.class, LoCType.SCOF_COMMENT_RATIO, false),
